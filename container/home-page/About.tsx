...
const marqueeImages = Array(12).fill("https://via.placeholder.com/970x700/f5f5f0/a19888.png?text=Client+Logo");
    ...
    <section className="w-full bg-gray-100 text-gray-800 py-32 px-8 sm:px-12 lg:px-16 relative overflow-hidden">
      ...
      <div className="text-center max-w-4xl mx-auto relative z-10 mb-40">
        ...
        <h1 className="font-['Gilda_Display'] text-5xl sm:text-6xl md:text-7xl font-normal mb-12 tracking-tight leading-tight">
          Welcome to <span className="text-stone-700 italic">The Social Moodboard</span>
        </h1>
            ...
            <div className={`w-full lg:w-1/2 ${index % 2 === 0 ? 'lg:pr-12' : 'lg:pl-12'} mb-12 lg:mb-0`}>
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-lg">
                  <img 
                    src={`https://via.placeholder.com/800x600/f5f5f0/8A7968.png?text=Service+${service.id}`} 
                    alt={service.title}
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {socialLinks.map((item) => (
            <a 
              ...
              className="flex items-center gap-4 px-8 py-4 bg-white rounded-xl border border-stone-200 text-stone-600 hover:text-stone-800 hover:shadow-sm transition-all duration-300 font-['Gilda_Display']"
            >
